      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
           <img src={Logo} alt="Coffee Shop Logo" className="h-18 w-auto" />
          </div>
          ...
          <div className="hidden md:block">
            <a
              ...
              className="bg-[#C67C4E] hover:bg-[#c67c4e]/80 text-white font-inter font-medium px-2 py-2 rounded-2xl cursor-pointer"
            >
              Comprar agora
            </a>
          </div>
          ...
          <div className="md:hidden">
            <a
              ...
              className="text-latte hover:text-foreground cursor-pointer transition-colors duration-200"
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-coffee-brown border-t border-border">
              ...
              <div className="px-3 py-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-[#C67C4E] hover:bg-[#c67c4e]/80 rounded-2xl py-1 px-2 text-white font-inter font-medium">
                  Comprar agora
                </a>
              </div>
            </div>
